...
</analysis>
{
  ...
  "extracted_facts": {
    ...
    "defendant_fault_indicators": { "value": "red-light T-bone; independent witness with contact info; CHP report pending with incident number", "evidence": { "quote": "I had the green. She ran the red and hit my passenger side.", "timestamp": "00:29", "speaker": "CALLER" }, "observability": "observed_on_call", "confidence": "high" },

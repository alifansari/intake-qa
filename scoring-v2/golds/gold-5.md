...
</analysis>
{
  ...
  "extracted_facts": {
    ...
    "defendant_fault_indicators": { "value": "relayed account: fetal-monitor strips showed prolonged distress; delayed emergency C-section — expert review required", "evidence": { "quote": "she says the monitor strips showed the baby was in distress for a long time and they waited way too long to do the C-section", "timestamp": "00:05", "speaker": "CALLER" }, "observability": "observed_on_call", "confidence": "medium" },

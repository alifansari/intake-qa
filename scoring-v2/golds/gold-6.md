...
</analysis>
{
  ...
  "extracted_facts": {
    ...
    "defendant_fault_indicators": { "value": "semi jackknifed across three lanes (loss of control); CHP closed freeway, worked scene for hours; DOT number recorded by officer", "evidence": { "quote": "He just lost it and came across three lanes.", "timestamp": "00:48", "speaker": "CALLER" }, "observability": "observed_on_call", "confidence": "high" },

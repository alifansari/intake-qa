...
# v2.2 — refer-out economics (tier language only, never dollars).
# capital_ceiling_tier: the firm's advanceable-cost appetite. When heavy
# capital meets a low ceiling, the refer comparison surfaces sooner.
#   low | moderate | high
capital_ceiling_tier: moderate
# referral_split_default: how the refer comparison frames the referred path.
#   pure_referral — CRPC 1.5.1 pure referral (near-zero hours/capital)
#   co_counsel    — active co-counsel (more hours, larger split)
referral_split_default: pure_referral
```
<!-- PART B: END -->

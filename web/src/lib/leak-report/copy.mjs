...
export function verdictSentence({ n, period, x, y, low, high }) {
  return `We reviewed ${n} recorded intake calls from ${period} and found ${x} qualified callers who did not sign. Of those, ${y} appear still recoverable today. The estimated fee value at risk is ${low} to ${high}.`;
}

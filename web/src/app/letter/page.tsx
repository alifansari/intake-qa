...
const REVISION_DATE = "July 9, 2026"; // last text revision; shown in the version line/colophon
      ...
      <article className={styles.letter} lang="en">
        ...
        <footer className={styles.attestation}>
          ...
          <div className={styles.monogramRow}>
            ...
            <span className={styles.version}>Version 1.3 · updated {REVISION_DATE}</span>
          </div>
        </footer>

        <aside className={styles.colophon}>
          <p>
            Changelog. 1.3: the invitation was updated for the beta window: the first five firms
            ...
            the free Leak Audit wedge, with the first five firms continuing on a flat-rate founding
            charter. 1.1: the invitation changed from a flat-fee audit to a founding-cohort

// "Self-Blame Is a Discount, Not a Decline" — cornerstone essay body.
//
// Stored as a small markdown subset (blank-line paragraphs, "## " headings,
// "- " list items, *italic* spans). Straight quotes and apostrophes here are
// converted to curly at render time by the page's deterministic renderer, so
// the source stays clean and the published page matches the site's typography.
// The essay contains NO em dashes by design; do not add any.
...
export const BODY = `A caller once told me she got rear-ended at a red light. Then, before I could ask a second question, she started walking it back. It was probably her fault too, she said. She was already braking. She should have left more room. She kept going, building the case against herself faster than I could write it down.
...
export const FOOTER_NOTE =
  "Ali F. Ansari is a former California personal injury paralegal who spent years taking intake calls. He now builds IntakeQA, which scores intake calls against California law.";

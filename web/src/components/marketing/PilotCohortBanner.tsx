...
import { STAKE_LINE, CHARTER_INTRO_PRICE, CHARTER_INTRO_DAYS } from "@/lib/site-constants";
    ...
    <div className="flex flex-col items-start gap-4 rounded-card border border-navy/20 bg-navy-tint px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
      <div className="flex items-center gap-3">
        ...
        <p className="text-sm font-medium text-ink">
          Start with a free Leak Audit; the first five firms can continue on the Charter at{" "}
          {CHARTER_INTRO_PRICE} for {CHARTER_INTRO_DAYS} days.{" "}

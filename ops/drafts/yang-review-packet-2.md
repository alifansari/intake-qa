...
- **Q3 (short answer — updated after channel research).** LACBA's published Listserve Guidelines ban commercial/vendor content, so we retargeted this piece to LinkedIn/newsletter and a CAALA Advocate pitch, and we rejected orchestrated proxy-posting outright. One gray zone remains: a LACBA Small Firm Section member *offered unprompted* to post our separate beta-team request (drafted by us) to the section listserv. Their offer, their account — but our text, our commercial benefit. Is the member's unprompted offer enough to make this their speech, or should we decline the offer (or require the member to write their own words without our draft)?
